...
<html lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/nexus.min.css">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/font-awesome.min.css">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/responsive.min.css">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/animate.min.css">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <link rel="stylesheet" href="assets/css/bootstrap.css" rel="stylesheet">
        <!-- Template CSS -->
        <link rel="stylesheet" href="animate.css" rel="stylesheet">
                    ...
                    <div class="col-md-12 no-padding">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                <li>
                                    <a href="homepage.php" class="fa-home">Home</a>
                                </li>
                                <li>
                                    <a href="homepage.php" class="fa-about-us">About Us</a>
                                </li>
                                <li>
                                    <a href="template.html" class="fa-profile">Profiles</a>
                                </li>
                                <li>
                               <!--     <a href="template.html" class="fa-deal">Offers</a>
                                </li>
                                <li>
                                    <a href="template.html" class="fa-agency">Agencies</a>
                                </li>
                                <li>
                                    <a href="template.html" class="fa-feed">Feedback</a>
                                </li>-->
                                <li>
                                    <a href="\doctor\Doctor_register.php" class="fa-sign-up">Doctor Sign up</a>
                                </li>
                                 <li>
                                    <a href="\patient\patient_register.php" class="fa-sign-up">Patient Sign up</a>
                                </li>
                                 <li>
                                    <a href="\doctor\doctor_login.php" class="fa-sign-up">Doctor login</a>
                                </li> 
                                <li>
                                    <a href="\patient\patient_login.php" class="fa-sign-up">Patient login</a>
                                </li>
                                <!--<li>
            ...
            <!--<div id="content">
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Text -->
                        <div class="col-md-12">
                            <h2 class="text-center text-primary">Doctor Consultancy System! </h2>
                            <p class="text-center">This is a website made to reduce the communication gap between doctor and patient. We aim to bring as much automation as possible in the process of interaction between doctor and patient. Waiting time can be reduced and lot of time can be reduced.</p>
                            <p class="text-center">People’s health problems are taking a toll with each
passing day. Patients have to make frequent visits to a doctor for even small complications.
Some patients require medical consultancy 24x7. Also it gets difficult for patients with
multiple problems to juggle between the appointment of different doctor at the same time.
Scheduling the visits becomes difficult. 
.</p>
                        </div>
                        <!-- End Main Text -->
                    </div>
                               ...
                               <!-- <li class="portfolio-item col-sm-6 col-xs-6 padding-20">
                                    <a href="#">
                                        <figure class="animate fadeInRight">
                                            <img alt="" src="assets/img/frontpage/image2.jpg">
                                            <figcaption>
                                                <h3></h3>
                                                <span></span>
                                            </figcaption>
