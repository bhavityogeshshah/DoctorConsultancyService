...
<div class="container">
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="submit" name="add" class="form-control" value="Add Doctor">
                </div>
              </div>
            </div>
 ...
 <?php
  ...
  $message = "Message";
    ...
    $delete = "Delete";
  if(isset($_POST["add"])) {
   $sql   = "INSERT into doc_pat_relation (doctor_id,patient_id, problem) values (".$doctor_id.",".$patient_id.",'".$field."') ";
        if($con->query($sql)=== TRUE){
            echo "<div class= 'success'>You have added doctor successfully.</br></div>";
 ?>
            <div align="center" class="message">
            <?php
            echo '<a href="message.php?d_id='.$doctor_id.'">'.$message.'</a>';
            ?>
            </div>
            <div align="center" class="book_appointment">
            <?php
            echo "<br>";
           echo '<a href="book_appointment.php?doctor_id='.$doctor_id.'">'.$book_appointment.'</a>';
           ?>
           </div>
           <?php
        }
        else{
          echo "Problem in adding doctor";
        }
  }
  ?>
